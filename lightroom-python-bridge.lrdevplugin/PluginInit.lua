...
local function registerApiCommands()
    ...
    router:register("catalog.getSmartCollectionCriteria", CatalogModule.getSmartCollectionCriteria, "sync")
    router:register("catalog.updateSmartCollection", CatalogModule.updateSmartCollection, "sync")
    router:register("catalog.deleteSmartCollection", CatalogModule.deleteSmartCollection, "sync")
    router:register("catalog.getKeywords", CatalogModule.getKeywords, "sync")
    router:register("catalog.getKeywordTree", CatalogModule.getKeywordTree, "sync")
    router:register("catalog.createKeyword", CatalogModule.createKeyword, "sync")
    router:register("catalog.batchStampByPath", CatalogModule.batchStampByPath, "sync")
    router:register("catalog.addPhotoKeywords", CatalogModule.addPhotoKeywords, "sync")
    router:register("catalog.removePhotoKeywords", CatalogModule.removePhotoKeywords, "sync")
    router:register("catalog.deleteKeyword", CatalogModule.deleteKeyword, "sync")
    router:register("catalog.batchDeleteKeywords", CatalogModule.batchDeleteKeywords, "sync")
    ...
    -- Phase 3: classifier stamper
    router:register("catalog.getCandidatesForClassification", CatalogModule.getCandidatesForClassification, "sync")
    router:register("catalog.applyClassification", CatalogModule.applyClassification, "sync")
